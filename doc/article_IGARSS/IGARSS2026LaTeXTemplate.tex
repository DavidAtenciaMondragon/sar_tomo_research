...
\title{\uppercase{\LaTeX\ Template for IGARSS 2026 Articles (with \BibTeX)}
\thanks{Identify applicable funding agency here. If none, delete this.}
}

\author{	\IEEEauthorblockN{David C.\ Frery\orcidlink{0000-0002-8002-5341}}
...
\maketitle
\begin{abstract}
	If this were an actual abstract, I would state the research question and why it is relevant for the community that will attend IGARSS 2026. I'd boldly say that this has not been done before in the way I've done it. Then, I would give an idea of the approach I took and summarize my key findings. I would conclude the abstract by stating how these findings serve to answer my research question.
\end{abstract}

\begin{IEEEkeywords}
	IGARSS 2026, \LaTeX, reproducibility, template.
\end{IEEEkeywords}
